...
const quickLinks = [
  ...
  { label: 'About', href: 'https://www.hhpf.in/about' },
  { label: 'Services', href: 'https://www.hhpf.in/#services' },
  { label: 'Products', href: 'https://www.hhpf.in/#products' },
  { label: 'Testimonials', href: 'https://www.hhpf.in/#testimonials' },
  { label: 'Contact', href: 'https://www.hhpf.in/contact' },
]

const services = [
  { label: 'Bach Flower Therapy', href: 'https://bachflowertherapy.hhpf.in/' },
  { label: 'Nadi Nakshatra Astrology', href: 'https://nadi-nakshatra.vercel.app/' },
  { label: 'Psychology', href: 'https://www.hhpf.in/psychology' },
  { label: 'Healing Products', href: 'https://www.hhpf.in/#products' },
]

const policyLinks = [
  { label: 'Privacy Policy', href: 'https://www.hhpf.in/privacy-policy' },
  { label: 'Terms of Service', href: 'https://www.hhpf.in/terms-of-service' },
  { label: 'Cancellation Policy', href: 'https://www.hhpf.in/refund-cancellation-policy' },
]
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 py-16">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <a href="tel:+919871468883" className="flex items-center gap-3 text-white/50 hover:text-[#C89A2B] transition-colors duration-200 group">
                ...
                <span className="font-body text-sm">+91 98714 68883</span>
              </a>
              ...
              <a href="https://www.hhpf.in" className="flex items-center gap-3 text-white/50 hover:text-[#C89A2B] transition-colors duration-200 group">
                <div className="w-8 h-8 rounded-lg bg-white/8 flex items-center justify-center flex-shrink-0 group-hover:bg-[#C89A2B]/20 transition-colors">
                  <Globe size={13} className="text-[#C89A2B]" />
                </div>
                <span className="font-body text-sm">www.hhpf.in</span>
              </a>
              <div className="flex items-start gap-3 text-white/50">
                ...
                <span className="font-body text-sm">Noida, UP &amp; Online Worldwide</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-6">
          ...
          <div className="flex gap-5">
            {policyLinks.map((item) => (
              <a key={item.label} href={item.href} className="font-body text-xs text-white/30 hover:text-[#C89A2B] transition-colors duration-200">
                {item.label}
              </a>
            ))}
          </div>
